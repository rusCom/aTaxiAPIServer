...
/**
 * Cache' Java Class Generated for class ataxi.API.Messages on version Cache for Windows (x86-32) 2010.2.2 (Build 600) Wed Dec 8 2010 16:51:00 EST.<br>
 *
...
public class Messages extends ataxi.API.JSON implements java.io.Serializable {
    private static final long serialVersionUID = 2852;
    private static String CACHE_CLASS_NAME = "ataxi.API.Messages";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>ataxi.API.Messages.open</code> instead!</br></p>
           <p>
    ...
    */
    ...
    /**
       Creates a new instance of object "ataxi.API.Messages" in Cache
       database and corresponding object of class
       <code>ataxi.API.Messages</code>.
    ...
    /**
       Returns class name of the class ataxi.API.Messages as it is in

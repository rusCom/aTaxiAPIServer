...
public class Exchange extends com.intersys.classes.RegisteredObject implements java.io.Serializable {
    ...
    */
    public Exchange (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public Exchange (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public Exchange (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
   ...
   */
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, Exchange.class);
    }
    ...
    /**
       ...
       @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#__OID"> __OID</A>
    */
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#%ClassName"> Method %ClassName</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#%IsA"> Method %IsA</A>
    */
    ...
    /**
     ...
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#Answer"> Method Answer</A>
    */
    ...
    */
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @param inOrganizationToken represented as java.lang.String
     @param inDispatchingToken represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#Auth"> Method Auth</A>
    */
    public static java.lang.String Auth (com.intersys.objects.Database db, java.lang.String inOrganizationToken, java.lang.String inDispatchingToken) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(inOrganizationToken);
        args[1] = new com.intersys.cache.Dataholder(inDispatchingToken);
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#GUID"> Method GUID</A>
    */
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#Initialize"> Method Initialize</A>
    */
    ...
    /**
     ...
     default argument inDispatchingID set to ""
     default argument inOderToken set to ""
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see #Orders(com.intersys.objects.Database,java.lang.String,java.lang.String,java.lang.String)
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#Orders"> Method Orders</A>
    */
    public static java.lang.String Orders (com.intersys.objects.Database db, java.lang.String inOrganizationID) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
    ...
    /**
     ...
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#Orders"> Method Orders</A>
    */
    public static java.lang.String Orders (com.intersys.objects.Database db, java.lang.String inOrganizationID, java.lang.String inDispatchingID) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(inOrganizationID);
    ...
    /**
     ...
     @param inOrganizationID represented as java.lang.String
     @param inDispatchingID represented as java.lang.String
     @param inOderToken represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#Orders"> Method Orders</A>
    */
    public static java.lang.String Orders (com.intersys.objects.Database db, java.lang.String inOrganizationID, java.lang.String inDispatchingID, java.lang.String inOderToken) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        args[0] = new com.intersys.cache.Dataholder(inOrganizationID);
        args[1] = new com.intersys.cache.Dataholder(inDispatchingID);
        args[2] = new com.intersys.cache.Dataholder(inOderToken);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"Orders",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#OrdersAdd"> Method OrdersAdd</A>
    */
    public static java.lang.String OrdersAdd (com.intersys.objects.Database db, java.lang.String inDispatchingID, java.lang.String inData) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
    ...
    /**
     ...
     @param inOderToken represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#OrdersDeny"> Method OrdersDeny</A>
    */
    public static java.lang.String OrdersDeny (com.intersys.objects.Database db, java.lang.String inOderToken) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(inOderToken);
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#addField"> Method addField</A>
    */
    ...
    /**
     ...
     @param inFieldValue represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#addToArray"> Method addToArray</A>
    */
    ...
    /**
     ...
     @param inFieldValue represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.Exchange#addToNamedArray"> Method addToNamedArray</A>
    */

...
public class MobileAPP extends com.intersys.classes.Persistent {
    ...
    /**
           ...
           <br>Use <code>API.MobileAPP.open</code> instead!</br></p>
           <p>
    ...
    */
    ...
    /**
       Creates a new instance of object "API.MobileAPP" in Cache
       database and corresponding object of class
       <code>API.MobileAPP</code>.
    ...
    * objects must be instances of <code>API.MobileAPP</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>API.MobileAPP</code> or of
      any of its subclasses. Cast to <code>API.MobileAPP</code> is
    ...
    * to open all instances of class API.MobileAPP
    ...
    */
    ...
    /**
       Returns class name of the class API.MobileAPP as it is in
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    public static API.MobileAPP IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        ...
        if (cobj == null)
            return null;
        return (API.MobileAPP)(cobj.newJavaInstance());
    }
    /**
     <p>Runs method IDKEYOpen in Cache.</p>
     @param db represented as com.intersys.objects.Database
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "API.MobileAPP_Extent", 0, 0);
    }

...
/**
 * Cache' Java Class Generated for class API.BaseAPI on version Cache for Windows (x86-32) 2010.2.2 (Build 600) Wed Dec 8 2010 16:51:00 EST.<br>
 *
...
public class BaseAPI extends com.intersys.classes.Persistent {
    ...
    private static String CACHE_CLASS_NAME = "API.BaseAPI";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>API.BaseAPI.open</code> instead!</br></p>
           <p>
    ...
    */
    ...
    /**
       Creates a new instance of object "API.BaseAPI" in Cache
       database and corresponding object of class
       <code>API.BaseAPI</code>.
    ...
    * objects must be instances of <code>API.BaseAPI</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>API.BaseAPI</code> or of
      any of its subclasses. Cast to <code>API.BaseAPI</code> is
    ...
    * to open all instances of class API.BaseAPI
    ...
    */
    ...
    /**
       Returns class name of the class API.BaseAPI as it is in
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    public static API.BaseAPI IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        ...
        if (cobj == null)
            return null;
        return (API.BaseAPI)(cobj.newJavaInstance());
    }
    /**
     <p>Runs method IDKEYOpen in Cache.</p>
     @param db represented as com.intersys.objects.Database
     ...
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.BaseAPI#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static API.BaseAPI IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://WIN-SXXN5RR5F37:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.BaseAPI#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static API.BaseAPI IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    */
    ...
    /**
     ...
     <p>Description: Возвращает 1, если в указанном классе, есть указанный метод</p>
     @param db represented as com.intersys.objects.Database
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "API.BaseAPI_Extent", 0, 0);
    }

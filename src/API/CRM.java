...
/**
 * Cache' Java Class Generated for class API.CRM on version Cache for Windows (x86-32) 2010.2.2 (Build 600) Wed Dec 8 2010 16:51:00 EST.<br>
 *
...
public class CRM extends API.JSON implements java.io.Serializable {
    private static final long serialVersionUID = 2787;
    private static String CACHE_CLASS_NAME = "API.CRM";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>API.CRM.open</code> instead!</br></p>
           <p>
    ...
    */
    ...
    /**
       Creates a new instance of object "API.CRM" in Cache
    ...
    /**
       Returns class name of the class API.CRM as it is in

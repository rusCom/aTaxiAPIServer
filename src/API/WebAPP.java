...
/**
 * Cache' Java Class Generated for class API.WebAPP on version Cache for Windows (x86-32) 2010.2.2 (Build 600) Wed Dec 8 2010 16:51:00 EST.<br>
 * Description: API для сайтов
 *
 * @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP</A>
**/

public class WebAPP extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 4133;
    private static String CACHE_CLASS_NAME = "API.WebAPP";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>API.WebAPP.open</code> instead!</br></p>
           <p>
    ...
    */
    public WebAPP (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public WebAPP (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
        super (((com.intersys.cache.SysDatabase)db).newCacheObject (CACHE_CLASS_NAME,initstr));
    }
    /**
       Creates a new instance of object "API.WebAPP" in Cache
       database and corresponding object of class
       <code>API.WebAPP</code>.
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public WebAPP (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    * objects must be instances of <code>API.WebAPP</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>API.WebAPP</code> or of
      any of its subclasses. Cast to <code>API.WebAPP</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #WebAPP(com.intersys.objects.Database)
     */
    ...
    * to open all instances of class API.WebAPP
    ...
    */
    ...
    /**
       Returns class name of the class API.WebAPP as it is in
   ...
   */
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, WebAPP.class);
    }
    /**
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%Exists"> Method %Exists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%IsA"> Method %IsA</A>
    */
...
extent physical data.</p>
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%KillExtent"> Method %KillExtent</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#Data"> Method Data</A>
    */
    public static java.lang.String Data (com.intersys.objects.Database db, java.lang.String inKey, java.lang.String inToken, java.lang.String inCity) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        args[0] = new com.intersys.cache.Dataholder(inKey);
        args[1] = new com.intersys.cache.Dataholder(inToken);
        args[2] = new com.intersys.cache.Dataholder(inCity);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"Data",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     <p>Runs method GetCities in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param inDispatchingID represented as java.lang.Integer
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#GetCities"> Method GetCities</A>
    */
    public static java.lang.String GetCities (com.intersys.objects.Database db, java.lang.Integer inDispatchingID) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(inDispatchingID);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"GetCities",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#GetPrefernces"> Method GetPrefernces</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static API.WebAPP IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        ...
        if (cobj == null)
            return null;
        return (API.WebAPP)(cobj.newJavaInstance());
    }
    /**
     <p>Runs method IDKEYOpen in Cache.</p>
     @param db represented as com.intersys.objects.Database
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static API.WebAPP IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static API.WebAPP IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    /**
     ...
     @param inIstest represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#OrdersAdd"> Method OrdersAdd</A>
    */
    public static java.lang.String OrdersAdd (com.intersys.objects.Database db, java.lang.String inToken, java.lang.String inCalcID, java.lang.String inNote, java.lang.String inPrice, java.lang.String inIstest) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[5];
        args[0] = new com.intersys.cache.Dataholder(inToken);
        args[1] = new com.intersys.cache.Dataholder(inCalcID);
        args[2] = new com.intersys.cache.Dataholder(inNote);
        args[3] = new com.intersys.cache.Dataholder(inPrice);
        args[4] = new com.intersys.cache.Dataholder(inIstest);
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#OrdersCalc"> Method OrdersCalc</A>
    */
    public static java.lang.String OrdersCalc (com.intersys.objects.Database db, java.lang.String inKey, java.lang.String inToken, java.lang.String inData, java.lang.String inWish, java.lang.String inRoute) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[5];
        args[0] = new com.intersys.cache.Dataholder(inKey);
        args[1] = new com.intersys.cache.Dataholder(inToken);
        args[2] = new com.intersys.cache.Dataholder(inData);
        args[3] = new com.intersys.cache.Dataholder(inWish);
        args[4] = new com.intersys.cache.Dataholder(inRoute);
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#OrdersDeny"> Method OrdersDeny</A>
    */
    public static java.lang.String OrdersDeny (com.intersys.objects.Database db, java.lang.String inToken, java.lang.String inReason) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(inToken);
    ...
    /**
     ...
     @param inCity represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#Preferences"> Method Preferences</A>
    */
    public static java.lang.String Preferences (com.intersys.objects.Database db, java.lang.String inKey, java.lang.String inToken, java.lang.String inLatitude, java.lang.String inLongitude, java.lang.String inCity) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[5];
        args[0] = new com.intersys.cache.Dataholder(inKey);
        args[1] = new com.intersys.cache.Dataholder(inToken);
        args[2] = new com.intersys.cache.Dataholder(inLatitude);
        args[3] = new com.intersys.cache.Dataholder(inLongitude);
        args[4] = new com.intersys.cache.Dataholder(inCity);
    ...
    /**
     ...
     @param inToken represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#ProfileGet"> Method ProfileGet</A>
    */
    ...
    /**
     ...
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#ProfileLogin"> Method ProfileLogin</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://WIN-V7V133H897X:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=ATAXI&CLASSNAME=API.WebAPP#ProfileRegistration"> Method ProfileRegistration</A>
    */
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "API.WebAPP_Extent", 0, 0);
    }
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("API", "WebAPP", 4, batch, con, nolock);
